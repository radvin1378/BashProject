...
Execute the "install.sh" as a superuser
 
It'll create the necessary files direcories and files

After it's execution, restart the system

Then at the termninal enter the command `deptmaint` to run the application.
